...
public:
    ...
    friend void coupling_3(vector<miser> &b1 ,vector<generous> &b2,vector<geek> &b3,vector<choosy> &g1 ,vector<normal> &g2,vector <desperate> &g3);
 ...
 void coupling_3(vector<miser> &b1 ,vector<generous> &b2,vector<geek> &b3,vector<choosy> &g1 ,vector<normal> &g2,vector <desperate> &g3);
